...
import { User, Mail, Lock, Edit2, Save, X, LogOut, Camera, Trash2Icon } from "lucide-react";
  ...
  return (
    <div className="w-full h-full flex flex-col p-[2vw]">
      ...
      <div className="w-full h-[8vh] flex items-center justify-between mb-[1vh]">
        ...
        <button 
        onClick={() => userDelete()}
         className="flex items-center gap-[0.5vw] text-red-500 hover:text-red-700 text-[1vw] font-medium transition-colors">
          <Trash2Icon className="w-[1.2vw]" /> Deletar usuario
        </button>
      </div>
